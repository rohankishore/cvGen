...
class Window(FramelessWindow):
    ...
    def __init__(self):
        ...
        self.uiInterface = ResumeBuilderWidget()
    ...
    def initNavigation(self):
        self.addSubInterface(self.uiInterface, FIF.MUSIC, 'UI', selectedIcon=FIF.SCROLL)
